...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = ''; //acho que é isso que estava faltando

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'Rebeca';
  ...
  */
   ...
   * @var string
   */
  public $Host          = 'smtp.rebecafonseca.x-br.com';
   ...
   * @var string
   */
  public $Username      = 'hostnet=rebecafonseca.x-br.com';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = '220495re';
   ...
   * @var bool
   */
  public $SMTPDebug     = true;//acho que mexi aqui tbm
 ...
 /**
  ...
  private function mail_passthru($to, $subject, $body, $header, $params) {
    if ( ini_get('safe_mode') || !($this->UseSendmailOptions) ) {
        ...
        $rt = @mail($to, mb_encode_mimeheader($subject,$this->CharSet, 'B', ''), $body, $header, $params);
    } else {

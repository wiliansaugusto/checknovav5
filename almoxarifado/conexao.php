...
if(isset($_POST['inseri'])){
    ...
    $sqlPesquisa= "SELECT nr_cpf FROM 	usuario where nr_cpf='".$CPF."'";
    ...
    $sqlIns="INSERT INTO usuario (nm_usuario, nm_login, ds_senha,email, nr_cpf, is_ativo, dt_alteracao, 
    tp_usuario) VALUES (?,?,?,?,?,?,?,?)";
...
if(isset($_POST['redf'])){
    ...
    $CPF = $_POST['nr_cpf'];
    $sqlPesquisa= "SELECT * FROM usuario where nr_cpf=?";
    $sthp= $conexao->prepare($sqlPesquisa);

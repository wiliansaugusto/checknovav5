        ...
        <div class="col s4">
         <div class="card-panel">
          ...
          <div class="input-field col s12">
            ...
            <label class="center-align" for="nm_usuario"><i class="small material-icons">  assignment_ind</i>
            <span class="center-align">Nome de Usuário</span></label>
          </div>
          </div>
          ...
          <div class="input-field col s12">
            ...
            <label class="center-align" for="senha"><i class="small material-icons">check</i>
            <span class="center-align">  Senha</span></label>
          </div>
          </div>
